...
def show_pred(net, viz_sample, joint_idx=0, alpha_pred=0.7, save_path=None, show_figure=False):
    """
...
def show_confmap_grid(net, viz_sample, plot=True, save_path=None, show_figure=False):
    """ 
