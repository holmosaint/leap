...
from leap.utils import load_dataset, load_video, load_label
...
def train_test(data_path, label_path, *,
    ...
    if len(input_layers) > 1 or len(output_layers) > 1:
        ...
        test_datagen = MultiInputOutputPairedImageAugmenter(input_layers, output_layers, test_box, test_confmap, batch_size=batch_size, shuffle=False, theta=(-rotate_angle, rotate_angle))
    else:
        ...
        test_datagen = PairedImageAugmenter(test_box, test_confmap, batch_size=batch_size, shuffle=False, theta=(-rotate_angle, rotate_angle))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_path_extra", type=str, default="", required=False, help="Add another video path")
    ...
    parser.add_argument("--test_video_path", type=str, default="", required=False, help="The test video path")
    parser.add_argument("--test_video_path_extra", type=str, default="", required=False, help="Add another test video path")
